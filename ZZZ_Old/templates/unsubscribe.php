...
<html lang="fr">
	<head>
        ...
        <title>Billet simple pour l'Alaska - Supprimer son compte</title>
        <meta name="description" content="La suppression d'un compte utilisateur sur le blog de Jean Forteroche">
    </head>
    <body>
        <div class="container">
            <section id="delete-profile">
                <?php
                    ...
                    $req = $bdd->prepare('DELETE FROM members WHERE pseudo = ?');
