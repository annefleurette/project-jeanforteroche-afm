...
<header> <!-- Barre de navigation qui intègre un bouton permettant à Jean Forteroche de se connecter à son espace personnel -->
    <nav class="navbar navbar-expand-lg fixed-top">
        <a class="navbar-brand" href="index.php">
            <img src="public/images/logo.png" class="d-inline-block align-top" alt="Jean Forteroche">Jean Forteroche
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav p-2">
                ...
                <li class="nav-item left-part">
                    <a class="nav-link" href="index.php?action=episode">Tous les épisodes</a>
                </li>
            </ul>
            <ul class="navbar-nav ml-auto p-2">
                ...
                ?>
                    <li class="nav-item right-part subscription">
                        <a class="nav-link" href="index.php?action=subscription">Inscription</a>
                    </li>
